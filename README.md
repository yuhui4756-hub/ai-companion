...
一个中文 BYOK（Bring Your Own Key，自带 API Key）AI 恋爱伴侣网页 Demo。当前 v0.4.2 以“单聊天页”为主体验：左侧只保留伴侣名字列表、新建和更多入口，中间专注聊天，顶部按钮打开伴侣、记忆、风格、设置和用户须知弹窗；旧朋友、理性支持、日常陪伴、角色陪伴类型默认收进更多/兼容入口。
